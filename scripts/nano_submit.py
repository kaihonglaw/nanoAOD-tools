...
''')
        for ifile,ofile in zip(inputFiles,outputFiles):
            iF += 1
            f.write("fileArray[{}]='python /vols/cms/khl216/CMSSW_10_2_18/src/PhysicsTools/NanoAODTools/processors/DQCD.py --input {} {}'\n".format(iF,ifile,outputDir))
